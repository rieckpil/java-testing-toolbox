...
public class GivenZendeskClientMock extends Stage<GivenZendeskClientMock> {
  ...
  @ProvidedScenarioState ZendeskApiClient zendeskApiClientMock;

  @ProvidedScenarioState Long zendeskTicketId = 1234L;

  public GivenZendeskClientMock a_mock_for_zendesk_client() {
    zendeskApiClientMock = mock(ZendeskApiClient.class);

    ReflectionTestUtils.setField(zendeskService, "zendeskApiClient", zendeskApiClientMock);
    return this;
  }

  public GivenZendeskClientMock the_mock_allows_ticket_creation() {
    Mockito.when(zendeskApiClientMock.createZendeskTicketForUser(any()))
        .thenReturn(zendeskTicketId);
    return this;
  }
}
